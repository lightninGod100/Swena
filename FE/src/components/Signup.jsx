  ...
  return (
    <div className="signup-page">
      <div className="signup-container">
        <div className="signup-logo" onClick={() => navigate('/')} style={{ cursor: 'pointer' }}>
          <h1>SEWNA</h1>
        </div>
          ...
          <div className="form-group checkbox-group">
            <label>
              <input
                ...
                required
              />
              <span>I agree to the <a href="https://www.joinsewna.com/terms" target="_blank" rel="noopener noreferrer">Terms and Conditions</a></span>
            </label>
          </div>
